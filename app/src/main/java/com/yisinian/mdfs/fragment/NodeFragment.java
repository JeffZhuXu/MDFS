 ...
 * <p/>
 * <p/>
 * Activities containing this fragment MUST implement the {@link OnNodeFragmentInteractionListener}
 * interface.
 */
public class NodeFragment extends ListFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnNodeFragmentInteractionListener) activity;
        } catch (ClassCastException e) {
            throw new ClassCastException(activity.toString()
                    + " must implement OnNodeFragmentInteractionListener");
        }
    }
