    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonA).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.containr,new A()).commit();
            }
        });
        ...
        findViewById(R.id.buttonB).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.containr,new B()).commit();
            }
        });
    }
